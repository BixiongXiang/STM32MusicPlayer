...
#define I2C1_SLAVE_ADDRESS7   0x70   // 0x70
...
* Return         : None
*******************************************************************************/
void I2C_shuma_ByteWrite(u8 pBuffer, u8 WriteAddr)
{ //I2C_EE_WaitEepromStandbyState();
  /* Send STRAT condition */
  I2C_GenerateSTART(I2C1, ENABLE);
...
* Return         : None
*******************************************************************************/
u8 I2C_KEY_BufferRead( u8 ReadAddr, u16 NumByteToRead)
{  
  u8    key1;
 // I2C_EE_WaitEepromStandbyState();
  /* Send START condition */
